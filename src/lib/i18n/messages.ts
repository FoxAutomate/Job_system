...
const et: Messages = {
  ...
  langEtShort: "ET",
  langEnShort: "EN (UK)",
  homeHeroEyebrow: "Canning Brothers Careers",
  homeHeroTitle: "Tule tööle Canning Brothersi meeskonda — joogitööstuse masinaehitus",
  homeHeroBody:
    "Canning Brothers ehitab ja seadistab villimisliine. Siit leiad avatud ametikohad — kandideeri kiiresti, ka telefonist.",
  ...
  jobFooterCompany: "Canning Brothers Careers · Canning Brothers",
  applySectionTitleGeneral: "Tahad liituda Canning Brothersi meeskonnaga?",
  ...
  formGdprConsentLabel:
    "Nõustun oma isikuandmete töötlemisega Canning Brothersi poolt värbamisprotsessi läbiviimiseks valitud ametikohale ja tulevasteks värbamisprotsessideks. Võin nõusoleku igal ajal tagasi võtta.",
  ...
  adminLoginDesc: "Canning Brothers Careers — sisemine haldus",
  ...
  adminDashSubtitle: "Canning Brothers Careers — kuulutused ja kandidaadid",
  ...
  adminFormTaglinePh: "Canning Brothers · Tallinn",
...
const en: Messages = {
  ...
  langEnShort: "EN (UK)",
  homeHeroEyebrow: "Canning Brothers Careers",
  homeHeroTitle: "Join beverage machinery engineering at Canning Brothers",
  homeHeroBody:
    "Canning Brothers builds and commissions filling lines. Browse open roles — apply quickly, including from your phone.",
  ...
  jobFooterCompany: "Canning Brothers Careers · Canning Brothers",
  applySectionTitleGeneral: "Want to join the Canning Brothers team?",
  ...
  formGdprConsentLabel:
    "I consent to the processing of my personal data by Canning Brothers for the purpose of carrying out the recruitment process for the selected position and for future recruitment processes. I may withdraw my consent at any time.",
  formGdprMoreInfo: "Lisainfo / More information",
  formCvTooLargeInline:
  ...
  adminLoginTitle: "Admin login",
  adminLoginDesc: "Canning Brothers Careers — internal admin",
  ...
  adminDashSubtitle: "Canning Brothers Careers — job posts and candidates",
